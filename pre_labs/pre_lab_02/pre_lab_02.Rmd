...
**Answer: This is important because if we are singling out these specific columns now, we can work with just this data rather than having to single them out again.**
...
**Answer: The dates are hyphened and in YYYY/MM/DD order.**
...
**Answer: Now they are listed in chronological order.**
...
**Answer: Mutating this data to create columns that show the total votes and the percentage of votes**
...
**Answer: I think this mutate statement is creating new columns for addresses within the data set containing Maryland, Washington, California, Louisiana, Florida, North Carolina, Massachusetts, West Virginia, and Virginia.**
...
**Answer: Yes, this code grouped the data by state and by the total expense amount in descending order. It makes sense that Maryland has the highest amount since it is the state where the data set originates. Virginia is a neighboring state, so their numbers make sense as well.**
...
1.  How many courses have less than 15 seats and are in the Journalism department?

2.  Which state has the lowest total expenditure amount?

3.  Which month has the least expenditures? Does this have any significance or meaning?
