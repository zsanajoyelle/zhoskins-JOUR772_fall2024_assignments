...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer: It is more aesthetically pleasing and has color, rather than the more dull model that we had in previous blocks.**
