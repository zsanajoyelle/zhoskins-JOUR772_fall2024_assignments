...
**Task** Run the following code. Describe the model output. What do you see? **Answer: The p-value of 0.6795 is much larger, but the r-value of -0.06 is much weaker. This basically shows that the correlation between education spending per pupil in 2021 and the percentage growth in Gross Domestic Product in 2021 is not statistically significant.**
