...
**Answer: group_by () counted the number of classes per term and arranged them by category, summarize (count classes = (n) added the number of classes in each group.**
...
1.  What are the most popular courses or most signed up for courses?

2.  Have there been any drastic changes in enrollment for specific courses?

3.  What are the most seats there have been in one class and what is it? Does this have any significance?
